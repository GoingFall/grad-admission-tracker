...
async function loadProjectData() {
    ...
    try {
        ...
        // 加载社交媒体数据
        try {
            const socialResponse = await fetch('data/social-media.json');
...
function renderProjectDetail() {
    ...
    admissionRateEl.textContent = projectData.admission_rate || '未知';
    admissionRateEl.className = `admission-rate ${getAdmissionRateClass(projectData.admission_rate)}`;
